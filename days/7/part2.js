...
const hands = data.split('\n').map(e => {
    ...
    const jokerCard = cards.find(e => e.type == 'J');
    if(jokerCard && cards.length > 1){
        cards.splice(cards.indexOf(jokerCard), 1);
        cards.sort((a, b) => b.amount - a.amount)[0].amount += jokerCard.amount;
    }
